...
/*   Updated: 2024/06/27 14:19:24 by waalexan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render_map(t_data *data)
{
	...
	mlx_string_put(data->mlx, data->win,
		SIZE_Q / 2.3 - 4, SIZE_Q / 2.1, 0xFFFFFF, ft_itoa(data->passo));
	mlx_string_put(data->mlx, data->win,
		SIZE_Q * 2 / 2.3 - 4, SIZE_Q / 2.1, 0xFFFFFF, ft_itoa(data->coin));
	mlx_string_put(data->mlx, data->win,
		SIZE_Q * 3.3 / 2.3 - 4, SIZE_Q / 2.1, 0xFFFFFF, ft_itoa(data->score));
